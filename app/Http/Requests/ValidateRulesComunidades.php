...
class ValidateRulesComunidades extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            "select_provincia" => "required|numeric|min:1",
            "select_localidad" => "required|numeric|min:1",
            "email_solicitud" => "email|max:50",
            "email_envio" => "email|max:50",
            "web" => "max:50",
            "facebook" => "max:50",
            "telefono1" => "max:13",
            "telefono2" => "max:13",
    ...
    public function messages()
    {
        return [//Asignamos un texto por cada regla sobre cada campo
            ...
            'email_solicitud.max' => 'Longitud máxima del e-mail1 :max caracteres.',
            'email_envio.email' => 'La direccion de e-mail2 no es valida.',
            'email_envio.max' => 'Longitud máxima del e-mail2 :max caracteres.',
