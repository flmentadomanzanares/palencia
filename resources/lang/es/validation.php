...
return [
	...
	*/
	...
	"confirmed"            => "El campo :attribute confirmación de no búsqueda.",
	...
	"max"                  => [
		...
		"array"   => "El campo :attribute no debe ser mayor que :max elementos.",
	],
	"mimes"                => "El campo :attribute debe ser a archivo del tipo :values.",
	"min"                  => [
		"numeric" => "El campo :attribute debe ser menor que :min.",
		"file"    => "El campo :attribute debe ser menor que :min kilobytes.",
		"string"  => "El campo :attribute debe debe ser menor que :min caracteres.",
		"array"   => "El campo :attribute debe ser menor que :min elementos.",
	],
