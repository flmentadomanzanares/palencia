...
class ColoresTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('colores')->insert(Array('nombre_color' => '#f44336', 'codigo_color' => "#f44336"));
        DB::table('colores')->insert(Array('nombre_color' => '#e91e63', 'codigo_color' => "#e91e63"));
        DB::table('colores')->insert(Array('nombre_color' => '#9c27b0', 'codigo_color' => "#9c27b0"));
        DB::table('colores')->insert(Array('nombre_color' => '#673ab7', 'codigo_color' => "#673ab7"));
        DB::table('colores')->insert(Array('nombre_color' => '#3f51b5', 'codigo_color' => "#3f51b5"));
        DB::table('colores')->insert(Array('nombre_color' => '#2196f3', 'codigo_color' => "#2196f3"));
        DB::table('colores')->insert(Array('nombre_color' => '#03a9f4', 'codigo_color' => "#03a9f4"));
        DB::table('colores')->insert(Array('nombre_color' => '#00bcd4', 'codigo_color' => "#00bcd4"));
        DB::table('colores')->insert(Array('nombre_color' => '#009688', 'codigo_color' => "#009688"));
        DB::table('colores')->insert(Array('nombre_color' => '#4caf50', 'codigo_color' => "#4caf50"));
        DB::table('colores')->insert(Array('nombre_color' => '#74d108', 'codigo_color' => "#74d108"));
        DB::table('colores')->insert(Array('nombre_color' => '#cddc39', 'codigo_color' => "#cddc39"));
        DB::table('colores')->insert(Array('nombre_color' => '#ffeb3b', 'codigo_color' => "#ffeb3b"));
        DB::table('colores')->insert(Array('nombre_color' => '#ffc107', 'codigo_color' => "#ffc107"));
        DB::table('colores')->insert(Array('nombre_color' => '#ff9800', 'codigo_color' => "#ff9800"));
        DB::table('colores')->insert(Array('nombre_color' => '#ff5722', 'codigo_color' => "#ff5722"));
